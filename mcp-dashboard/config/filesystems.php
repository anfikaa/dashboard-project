    ...
    */
    ...
    'disks' => [
        ...
        's3' => [
            ...
            'credentials' => AwsCredentialFactory::provider(),
            ...
            'retries' => max(0, (int) env('AWS_S3_RETRIES', 0)),
            'http' => [
                'connect_timeout' => max(1, (int) env('AWS_S3_CONNECT_TIMEOUT', 2)),
                'timeout' => max(1, (int) env('AWS_S3_TIMEOUT', 4)),
            ],
